'''This is a custom scraper designed to scrape all papers from Persecpectives in Ecology and Conservation, published by Elseiver/ScienceDirect.
...
abstract_url = 'https://www.sciencedirect.com/search/advanced?pub=Perspectives%20in%20Ecology%20and%20Conservation&cid=315842&origin=jrnl_archive&zone=qSearch&qs=&show=100&offset='
...
def pages_to_scrape_number(url):
	...
	return int((soup.find('ol', {'class':'Pagination hor-separated-list'}).text.split(" ")[3]).split('n')[0])
...
def abstract_writer(abstract):
	...
	abstract_write = open('PerspectivesInEcologyAndConservation.txt', 'a')
