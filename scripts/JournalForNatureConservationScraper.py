...
abstract_url = 'https://www.sciencedirect.com/search/advanced?pub=Journal%20for%20Nature%20Conservation&cid=273182&origin=jrnl_archive&zone=qSearch&qs=&show=100&offset='
...
def abstract_writer(abstract):
	...
	abstract_write = open('JournalForNatureConservation.txt', 'a')
